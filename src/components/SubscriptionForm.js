  ...
  render() {
    return (
      <div id="mc_embed_signup">
        <Form
          action="https://company.us19.list-manage.com/subscribe/post?u=9df0751a5ba0993bf12104954&amp;id=ba8076c7c9"
          method="post"
...
const SubscribeButton = styled.input`
  ...
  &:focus {
    background-color: darken(#0c35fb, 10);
  }
  font-weight: 400;
  &.error {
